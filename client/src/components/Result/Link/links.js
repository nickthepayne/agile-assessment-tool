  ...
  team: [
    {
      ...
      abstract:
        'If you ask someone to estimate how long a bug will take to fix, without historic data you’ll get a '
    ...
    },
    {
      ...
      abstract:
        'Here’s a handy way to collectively challenge each other to improve in a constructive way. '
    ...
    },
    {
      ...
      abstract:
        'Here are some useful things for agile software development teams to be measuring in order to '
    ...
    },
    {
      ...
      abstract:
        'bout 2 minutes before commencing a recent retrospective, a team member '
    ...
    },
    {
      ...
      abstract:
        'The 3Ls is a great data gathering activity which emphasizes learning, '
    ...
    },
    {
      ...
      abstract:
        'Velocity can be a very useful predictor of how much work an agile team will complete '
    ...
    },
    {
      ...
      abstract:
        'The team could handle massive, unpredictable waves of customers and work under '
        + 'incredibly intense pressure for prolonged periods of time...',
    },
    {
      title: 'Upgrade your sprint planning',
      url:
        'https://www.scrum.org/resources/blog/upgrade-your-sprint-planning-gain-engagement-your-development-team',
      abstract:
        'In some teams around the world, Sprint Planning is seen as the most'
    ...
    },
    {
      ...
      abstract:
        ' Planning your next agile retrospective? Start with a random plan, change it to'
    ...
    },
    {
      ...
      abstract:
        'Agile techniques can be used to lead a company. Autonomy only scales if leaders'
    ...
    },
    {
      ...
      abstract:
        'With your team, read the definition of each attribute (displayed below) of healthy, high-performing teams out loud... ',
    },
  ],
  'project/product': [
    {
      ...
      abstract:
        'I got a question from one of the blog readers on how I would describe a spec with examples '
    ...
    },
    {
      ...
      abstract:
        'A user story in Scrum is an evolving description of something your customer '
    ...
    },
    {
      ...
      abstract:
        'For the longest time, making a great experience for the user was a business-strategy luxury item. '
    ...
    },
    {
      ...
      abstract:
        'There was thinking. There were discussions. That all'
    ...
    },
    {
      ...
      abstract:
        'At any given time, an agile product backlog will contain a prioritized list of desired features...',
    },
    {
      title: 'Atlassian: Leadership Project Health Monitor',
      url: 'https://www.atlassian.com/team-playbook/health-monitor/project-teams',
      abstract:
        'A Health Monitor grid is where you record the team ratings for each attribute. It is best'
  ...
  organization: [
    {
      ...
      abstract:
        'When we think about what makes Agile such an effective approach to software product development,'
    ...
    },
    {
      ...
      url:
        'https://www.neilkillick.com/articles/why-aren-t-we-getting-results-from-our-agile-transition',
      abstract:
        'In my work as an independent agile consultant, senior or middle managers from companies... ',
    },
    {
      title: '8 ways to "go agile" without an "Agile transformation"',
      url:
        'https://www.neilkillick.com/articles/8-ways-to-go-agile-without-an-agile-transformation',
    ...
    },
    {
      ...
      abstract:
        'Do you feel like you’re not fully engaged with your team? Are you only having catch-ups when '
    ...
    },
    {
      ...
      abstract:
        'One of the most common comments I hear when talking Agile practices with organisations is that they '
    ...
    },
    {
      ...
      abstract:
        'Assessing whether an organization is agile is difficult. An organization could be agile...',
    },
    {
      ...
      abstract:
        'To survive and thrive today, many organizations are undertaking the fundamental'
    ...
    },
    {
      ...
      abstract:
        'Dealing with multiple teams in an product development organization is always a challenge.'
  ...
  scrum: [
    {
      ...
      abstract:
        'One of the most controversial updates to the 2011 Scrum Guide '
        + 'has been the removal of the term “commit” in favor of “forecast”... ',
    },
    {
      title: 'Scrum Master Advice',
      url:
        'https://www.scrum.org/resources/blog/path-scrum-mastery-avoiding-5-common-scrum-master-traps',
      abstract:
        'In my career, I have had the great privilege to witness different '
    ...
    },
    {
      ...
      abstract:
        'This is a sample agenda for a sprint planning meeting. '
    ...
    },
    {
      ...
      abstract:
        'For those of us who are practicing Agile coaches, you know the truth in this quote.'
    ...
    },
    {
      ...
      url:
        'https://www.frontrowagile.com/blog/posts/74-the-role-of-a-product-owner-responsibilities-and-characteristics',
